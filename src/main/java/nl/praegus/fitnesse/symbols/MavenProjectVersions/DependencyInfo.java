...
public class DependencyInfo {
    ...
    public DependencyInfo(String pluginGroup, String pluginArtifact) {
        ...
        this.latestVersionUrl = "https://repo.maven.apache.org/maven2/%s/%s/maven-metadata.xml";
    ...
    // Other Dependencies with latestVersionUrl
    public DependencyInfo(String group, String artifact, String versionInPom, Model model, String latestVersionUrl) {
        this.artifactId = artifact;
        this.versionInPom = convertMavenVariableToVersion(versionInPom, model);
